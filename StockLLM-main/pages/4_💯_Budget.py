...
if st.button("Get Recommendations"):
    ...
    analysis=llm(f"Give detail stock analysis, Use the available data and provide investment recommendation. You have the following information available {recommendations}. Write (5-6) lines investment analysis to answer user query, At the start itself give recommendation to user about the stock.")
